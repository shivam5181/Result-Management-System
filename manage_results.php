...
<style>
     body {
           ...
           background-image:url("./images/manage_result.jpg");
           color: white;
       }
</style>
<body>
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="p1" id="" placeholder="Physics">
                <input type="text" name="p2" id="" placeholder="Chemistry">
                <input type="text" name="p3" id="" placeholder="Mathematics">
                <input type="text" name="p4" id="" placeholder="DSA">
                <input type="text" name="p5" id="" placeholder="DAA">
